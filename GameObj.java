...
public abstract class GameObj {
     ...
     */
    public void bounce(org.cis120.snake.Direction d) {
        if (d == null) {
            return;
        }
     ...
     */
    public org.cis120.snake.Direction hitWall() {
        if (this.px + this.vx < 0) {
            return org.cis120.snake.Direction.LEFT;
        } else if (this.px + this.vx > this.maxX) {
            return org.cis120.snake.Direction.RIGHT;
        }

        if (this.py + this.vy < 0) {
            return org.cis120.snake.Direction.UP;
        } else if (this.py + this.vy > this.maxY) {
            return org.cis120.snake.Direction.DOWN;
        } else {
            return null;
        }
    }
     ...
     */
    public org.cis120.snake.Direction hitObj(GameObj that) {
